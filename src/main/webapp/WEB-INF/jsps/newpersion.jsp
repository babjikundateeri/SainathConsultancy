    ...
    <body>
        <div>
            <form method="post" action="#" th:action="@{/persons/new}" th:object="${personFormBean}">
                <div>
                    <div><input type="text" palceholder="First Name" th:field="*{firstName}" /> </div>
                    <div><input type="text" palceholder="Last Name" th:field="*{lastName}" /> </div>
                ...
                <div>
                    ...
                    <div><input type="rest" value="Reset"/></div>
                </div>
            </form>
        </div>
    </body>
